...
## \## [에임즈 인트로]{style="font-size: 14px;"}

-   블라블라

## [연속형 \> 박스플롯 / 범주형 \> 그래프, 조건별 결과 ]{style="font-size: 14px;"}
...
## [회귀모델]{style="font-size: 14px;"}

1.  

2.  

## [결론 및 보완점]{style="font-size: 14px;"}
...
<div style="display: flex; gap: 10px; align-items: flex-start;">
  <img src="fakeroom1.png" style="width: 49%;" alt="첫 번째 이미지">
  <img src="fakeroom2.png" style="width: 49%;" alt="두 번째 이미지">
</div> 
